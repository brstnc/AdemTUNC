...
@section('content')
    ...
    <form method="post" action="{{ route('admin.category.save', $entry->id) }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Kategori Adı" value="{{ $category->category_name }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_name">Mevcut İçerik Fotoğrafları</label>
